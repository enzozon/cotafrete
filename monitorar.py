...
# Importada, e não copiada, pelo mesmo motivo: a Della Volpe agora entra e
# sai dela conforme o .env (DV_AUTOMATICA_DESDE).
from web.transportadoras import AUTOMATICAS  # noqa: E402
